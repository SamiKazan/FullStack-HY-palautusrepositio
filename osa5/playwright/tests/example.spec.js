...
describe('Blog app', () => {
  ...
  describe('When logged in', () => {
    ...
    test('A new blog can be created', async ({ page }) => {
      ...
      await expect(page.getByText('Added New Blog testiblogi by testaaja')).toBeVisible()
    ...
    test('A new blog can be deleted after creation', async ({ page }) => {
      ...
      await expect(page.getByText('Deleted poistoblogi by poistotestaaja')).toBeVisible()
